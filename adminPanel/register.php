...
$email = $_POST['emailAddress'];
$pass = $_POST['password'];
$sql = mysqli_query($conn,"SELECT userName, userID, specialty, userQualification, userPhoto, password, status  FROM users WHERE `email` = '$email' ");
...
$sq = mysqli_fetch_assoc($sql);
	...
	$_SESSION['status'] =    $sq['status'];
	echo "<div class=\"wrapper\" align=\"center\"> <h2>Login Successful</h2> </div>";
	echo  "<br>";
	echo  "<div class=\"wrapper\" align=\"center\"> redirecting...STATUS: ".$sq['status']." </div>";
