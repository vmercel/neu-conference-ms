...
//$conn = mysqli_connect('fdb29.awardspace.net', '3664631_websm', '75by}D%^6MqNHR%S', '3664631_websm');
      ...
      $lat = (float)"35.1949379";//$_POST['latitude'];
      $long = (float)"33.3568717";//$_POST['longitude'];
      $userID = "AA000371";//$_SESSION['userID'];
...
$sql = mysqli_query($conn, " UPDATE attendanceregister SET timeOut = '$newTimeOut', status ='$newStatus' WHERE userID ='$userID' AND sessionID='$sessionID' ");
