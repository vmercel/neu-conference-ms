	...
	<div class="container-fluid">
		<nav class="navbar navbar-inverse" role="navigation">
			<div class="container-fluid">
				...
				<div class="collapse navbar-collapse navbar-right" id="navgatn_menu">
					<ul class="nav navbar-nav">
						...
						<li class="active"><a href="adminPanel/index.php"><span class="glyphicon glyphicon-cog"></span> AdminArea</a></li>
						<li class="active"><a href="conferences.php"><span class="glyphicon glyphicon-blackboard"></span> Conferences</a></li>
						<li class="active"><a href="blockchain.php"><span class="glyphicon glyphicon-th-list"></span> Blockchain</a></li>
						<?php
			...
			<li><a href="#abt_douphix" data-toggle="modal">
						...
						<?php if(isset($_SESSION['userID'])){echo "<li class=\"\"><a href=\"logout.php\">
